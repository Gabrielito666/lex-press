...
/**
 * @import { RouteProps } from "#lib/routes-handler"
 ...
 */
const buildFRONT = (routeProps, minify) =>
{
	if(routeProps.ext === "jsx")
	{
		return buildFRONT.jsx(routeProps.page, routeProps.layout, minify);
	}

	return buildFRONT.html(routeProps.page, minify);
};
...
buildFRONT.html = async(input, minify) =>
{
	...
	return { htmlText: htmlString, assets };
};
