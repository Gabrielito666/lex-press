 ...
 * @param {string} [baseUrl] Prefijo bajo el cual está montada la app
 * ("" en la raíz, "/app-2" bajo app1.use("/app-2", app2)). Se usa para que
 * el script de hot-reload apunte al SSE de esta app.
 * @returns {string} HTML completo con estilo inline
 */
const buildErrorHtml = (err, baseUrl = "") => `<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="utf-8">
...
<script src="${baseUrl}/__lexpress-reload.js" type="module"></script>
</head>
<body>
<div class="container">
${
